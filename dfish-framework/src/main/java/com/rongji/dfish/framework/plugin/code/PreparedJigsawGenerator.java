...
public class PreparedJigsawGenerator extends AbstractJigsawGenerator<PreparedJigsawGenerator> {
    ...
    private void initEnv() {
        ...
        //给三个都安排上任务。
        ExecutorService B_IMAGE_ES=ThreadUtil.newSingleThreadExecutor();
        ExecutorService S_IMAGE_ES=ThreadUtil.newSingleThreadExecutor();
        ExecutorService SAVE_FILE_ES=ThreadUtil.newSingleThreadExecutor();
        ExecutorService IMAGE_ES=ThreadUtil.newSingleThreadExecutor();
        ...
        IMAGE_ES.submit((Runnable) ()->{
            while(true){
                ...
                try {
                    Future<BufferedImage> imgS = S_IMAGE_ES.submit(new GeneratorSmallImage(this,rawFile, x, y, smallSize, smallSize));
                    Future<BufferedImage> imgB = B_IMAGE_ES.submit(new GeneratorBigImage(this,rawFile, x, y, smallSize, smallSize));
