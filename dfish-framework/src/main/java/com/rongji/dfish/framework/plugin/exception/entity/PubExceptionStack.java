...
@Entity
@Table(name = "PUB_EXCEPTION_STACK")
public class PubExceptionStack  implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof PubExceptionStack)){
			return false;
		}
		PubExceptionStack cast=(PubExceptionStack)obj;
