...
public interface TableOperation<T> {
	 ...
	 * <p>o 可以是String Widget 或者 Td。实际上都相当于一个Td里面的内容可以被简写，详见{@link com.rongji.dfish.ui.auxiliary.TD}</p>
	 * @param row 行
	 * @param column 列
	 * @param o 对象
	 * @return this
	 ...
	 * <p>删除节点后可能会留下空行和空列，可以用{@link Table#minimize()}来删除空行和空列。或去rows和column中手动清理</p>
	 * @param row 行
	 * @param column 列
	 * @return this
	 */
