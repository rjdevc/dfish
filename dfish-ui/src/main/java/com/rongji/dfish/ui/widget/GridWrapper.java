 ...
 * @since dfish 2.0
 */
public class GridWrapper extends AbstractGridWrapper<GridWrapper> {
...
//		bundleProperties();
     ...
     * @return this
     */
	public GridWrapper setFocusRowIndex(Integer focusRowIndex) {
     ...
     * @return this
     */
	public GridWrapper setFocusRowIndexs(Collection<Integer> focusRowIndexs) {
     ...
     */
    public GridWrapper setGridData(Collection<?> gridData) {
...
//    			prototype.getColumns().add(gridColumn);
	 ...
	 * @return 本身，这样可以继续设置其他属性
	 */
	public GridWrapper setLimit(Integer limit) {
	 ...
	 * @return 本身，这样可以继续设置其他属性
	 */
	public GridWrapper setCombo(Combo combo) {
