...
/**
 * Date 相对应前端的时间选择按钮，格式yyyy-MM-dd
 * 因为3.0自动代码生成需要改为更易理解的格式。
 * @author DFish Team
 * @version 2.0 
 * @since XMLTMPL 1.0
 */
public class MuldatePicker extends AbstractInput<MuldatePicker,Object> {
     ...
     * @param format String
     */
    public MuldatePicker(String name, String label, Object value, String format) {
		this.setName(name);
		this.setLabel(label);
		this.setValue(value);
		calFormat(format);
	...
	@Override
	public MuldatePicker setValue(Object value) {
		this.value=value;
		return this;
	}
}
