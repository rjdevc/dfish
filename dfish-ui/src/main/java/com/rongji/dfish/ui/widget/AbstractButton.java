...
public abstract class AbstractButton<T extends AbstractButton<T>> extends AbstractContainer<T> implements MultiContainer<T, Widget<?>>,HasFormat<T>,HtmlContentHolder<T> {
