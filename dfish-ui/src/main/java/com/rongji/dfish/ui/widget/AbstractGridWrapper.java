...
public abstract class AbstractGridWrapper<T extends AbstractGridWrapper<T>> extends AbstractWidgetWrapper<T, Grid> implements Scrollable<T>,HiddenContainer<T>,PubHolder<T,Tr>, ListView<T>,PrototypeChangeable<Grid>{
