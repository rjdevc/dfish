...
public class CryptFactory {
   ...
   * 这里用BASE64
   */
  public static final int BASE64 = StringCryptor.BASE64;
  /**
   * 先调用压缩算法，再转成BASE_64 
   ...
   * 这里用BASE32
   */
  public static final int BASE32 = StringCryptor.BASE32;
  /**
   * 由于加解密内码为byte[]要通过一种方法转存成字符串
   * 这里用十六进制表达
   */
  public static final int HEX_STRING = StringCryptor.HEX_STRING;
  /**
   * 内码转化成字符串所用的方法
   * 这里用BASE64算法转化然後把BASE64的+/=符號替換成網絡傳輸中不失真的字符-_.
   */
  public static final int URL_SAFE_BASE64 = StringCryptor.URL_SAFE_BASE64;
   ...
   * 字符集GBK
   */
  public static final String GBK = StringCryptor.GBK;
  /**
   * 字符集UTF-8
   */
  public static final String UTF8 = StringCryptor.UTF8;
  /**
   * 字符集用UTF-8,并对产生的byte数组进行一次GZIP压缩
   */
  public static final String UTF8_GZIP = StringCryptor.UTF8_GZIP;
  /**
   * 字符集UNICODE
   */
  public static final String UNICODE = StringCryptor.UNICODE;
   ...
   * @return 加解密工具
   */
  public static StringCryptor getStringCryptor(String algorithms,
                                               String encoding,
                                               int presentStyle) {
