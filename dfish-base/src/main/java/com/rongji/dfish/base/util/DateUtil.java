...
public class DateUtil {
     ...
     * 精确到分钟的格式(无年份)
     */
    public static final String PATTERN_MINUTE_SHORT = "MM-dd HH:mm";
    /**
     * 到日期的格式
     */
     ...
     * 该级别可以用来 转化成文本 也可以用来解析成时间
     */
    public static final int LV_MONTH = 5;
    /**
     * 时间级别-精确到年的格式yyyy
     * 该级别可以用来 转化成文本 也可以用来解析成时间
     */
    public static final int LV_YEAR = 6;
     ...
     * 该级别仅可以用来 转化成文本
     */
    public static final int LV_LIST = 11;
    /**
     * 时间级别-列表扩展格式， 可以更加友好的根据语言，显示更合适的时间格式
     * 如今天 13:00等
     * 该级别仅可以用来 转化成文本
     */
    public static final int LV_LIST_ADV = 12;
     ...
     * 该级别仅可以用来 转化成文本
     */
    public static final int LV_LIST_ADV_SHORT = 13;
