...
//            --monCyl;
    ...
    public String toString() {
        ...
        return getChineseYearString(year) + "(" + year + ")" + getChineseMonthString(month, leapMonth)
    ...
    /**
     * 获取实际农历日期
     * <p>String[0]-是否闰月,闰月String[0]为"1",否则为"0"</p>
     * <p>String[1]-农历日期,以字符串形式来显示,格式为yyyy-MM-dd</p>
     *
     * @return 实际农历日期字符
     */
    public String[] getActualLunarDateStr() {
        return new String[]{(leapMonth ? "1" : "0"), getStrLunarDate()};
    }
     ...
     * 获取一些年份农历年份数据集合
     *
     * @param beginLunarYear 开始的农历年份(包含此年)
     * @param endLunarYear   结束的农历年份(不包含此年)
     ...
     *
     * @param lunarDateStr 农历生日字符串(格式如:yyyy-MM-dd)
     * @param isLeapMonth  是否闰月
     * @param afterYears   几年后
     * @return 几年后生日的公历日期
     */
     ...
     * 将农历字符串转换成农历日期信息类
     *
     * @param lunarDateStr 农历日期字符串,格式如:yyyy-MM-dd
     * @param isLeapMonth  是否闰月
     * @return 农历日期信息
     */
     ...
     *
     * @param birthdayDate 农历生日对应的公历日期
     * @param isLeapMonth  是否闰月
     * @param afterYears   几年后
     * @return 几年后生日的公历日期
     */
