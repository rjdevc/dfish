...
// * @param <I>
// * @param <O>
// * @deprecated QueuedBatchFunction
// */
//@Deprecated
//public class QueuedBatchAction<I, O> implements BatchAction<I,O>{
//	private BatchAction<I, O> function;//注册进来的实际的批量获取实现
...
//	 * @param function 实际计算结果的方法。
//	 */
//	public QueuedBatchAction(BatchAction<I, O> function, int maxThread, int batchSize) {
