...
_merge($, {
	...
	print: function(a, y) {
		...
		d.write('<!doctype html><html class=f-print><head><meta charset=utf-8><title>' + $.loc.print_preview +
			'</title><style>.f-print .w-f-remark{height:auto;line-height:inherit}.w-input-s{border-bottom:1px solid red;word-break:normal;white-space:normal}.w-input-s:empty:before{content:"\xa0"}</style><script>var $={e:function(){}}</script>' + c.join('') +
