    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
			...
			var u = navigator.userAgent.toLowerCase(),
				n = u.indexOf( 'trident' ) > 0 && document.documentMode > 10,
				ie = navigator.appName === 'Microsoft Internet Explorer', // ie version <= 10
				mimeTypes = 'image/*';
			if ( ! (ie || n) ) {
				mimeTypes = 'image/jpeg,image/gif,image/png,image/bmp,image/tiff';
			}
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        $file.find('.error').text(json.state || 'error').show();
                        // add by cmy
                        if ( editor.dfishWidget ) {
                       		json.style = 'z-index:2;';
                        	editor.dfishWidget.cmd( json );
                        }
                    }
                } catch (e) {
