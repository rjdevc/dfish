...
define( {
  ...
  "iconfont": {
  	...
  	remark: {
  		...
  		nodes: [
  			...
  			{ src: '.f-i-leaf-folder', text: '.f-i-leaf-folder' },
  			{ src: '.f-i-leaf-folder-open', text: '.f-i-leaf-folder-open' },
  			{ src: '.f-i-leaf-file', text: '.f-i-leaf-file' },
  ...
  "PageBar": {
    ...
    Config: [
      ...
      { name: 'limit', type: 'Number', remark: '每页条数。' },
      ...
      { name: 'offset', type: 'Number', remark: '当前页偏移量。' },
      { name: 'pageSize', type: 'Number', remark: '每页显示多少条。配合target参数使用。' },
      { name: 'prevText', type: 'String', optional: true, remark: '"上一页"的文本。' },
      { name: 'src', type: 'String', optional: true, remark: '点击页数按钮将通过ajax访问此地址。后台应返回一个 command。支持变量 <b>$0</b> 代表 offset 值，<b>$1</b> 代表 limit 值。支持以 "javascript:" 开头的JS语句。' },
      { name: 'size', type: 'Number', remark: '总条数。' },
